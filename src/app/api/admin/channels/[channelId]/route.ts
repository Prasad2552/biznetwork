    ...
    try {
        ...
        const contentCounts = {
          ...
          events: channel.eventCount || 0,
            techNews: channel.techNewsCount || 0, //THIS LINE
        };
        ...
        const response: ChannelResponse = {
            ...
            logo: channel.logo,
            banner: channel.banner, //THIS LINE
            ...
            techNewsCount: channel.techNewsCount, //THIS LINE
        };
...
export async function PUT(
  ...
  { params }: { params: { channelId: string } }
    ...
    try {
        ...
        const bannerFile = formData.get('banner') as File | null; //get banner
        const userId = uuidv4();
        ...
        const bannerUrl = bannerFile ? await uploadFileToS3(bannerFile, userId, 'channel_banner') : undefined;// Upload to S3
    ...
    const contentCounts = {
        ...
        events: updatedChannel.eventCount || 0,
            techNews: updatedChannel.techNewsCount || 0, //THIS LINE
    };
        ...
        const response: ChannelResponse = {
          ...
          logo: updatedChannel.logo,
            banner: updatedChannel.banner, //THIS LINE
          ...
          createdAt: updatedChannel.createdAt.toISOString(),
           updatedAt: updatedChannel.updatedAt.toISOString(),
             contentCounts: contentCounts,
               techNewsCount: updatedChannel.techNewsCount, //THIS LINE
        };
