...
export async function GET(
  ...
  try {
    ...
    const response: DemoResponse = {
      ...
      featuredImage: post.featureImageUrl?.startsWith("/") &&
        !post.featureImageUrl?.startsWith("/uploads/")
      ...
      videoUrl: post.filePath?.startsWith("/") && !post.filePath?.startsWith("/uploads/")
        ...
        : post.filePath,
      thumbnailUrl: post.featureImageUrl?.startsWith("/") &&
        !post.featureImageUrl?.startsWith("/uploads/")
        ? baseUrl + post.featureImageUrl
        : post.featureImageUrl,
    };
    ...
    console.error("Error in /api/demos/[id]:", error);
