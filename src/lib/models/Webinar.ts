//src\lib\models\Webinar.ts
import mongoose, { Schema, model, models, Types } from 'mongoose';
import { BaseContent } from '@/types/content'; // Import BaseContent

export interface IWebinar extends BaseContent { //Extends BaseContent
    likes: number;
    dislikes: number;
    views: number;
  duration: number;
...
const Webinar = (models.Webinar || model<IWebinar>('Webinar', webinarSchema))
