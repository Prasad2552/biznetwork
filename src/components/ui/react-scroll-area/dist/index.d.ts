...
// Keep ScrollAreaThumbProps since it adds forceMount
...
// Remove ScrollAreaCornerProps since it’s empty and redundant
type ScrollAreaCornerProps = ScrollAreaCornerImplProps; // Use type alias instead of interface
declare const ScrollAreaCorner: React.ForwardRefExoticComponent<ScrollAreaCornerProps & React.RefAttributes<HTMLDivElement>>;
// Remove ScrollAreaCornerImplProps since it’s empty and redundant
type ScrollAreaCornerImplProps = PrimitiveDivProps; // Use type alias instead of interface
